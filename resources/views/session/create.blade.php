                        ...
                        <div class="card mb-4">
                            ...
                            <form method="post" action="{{url('session')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            <label for="session_name">Section Name</label>
                                            <input class="form-control" id="session_name" name="session_name" type="text" placeholder="Enter your last name" />
                                        </div>
                                        <div class="col-md-6 form-group mb-3">
                                            <label for="start_year">Start Year</label>
                                            <input class="form-control" id="start_year" name="start_year" type="Year" placeholder="Enter email" />
