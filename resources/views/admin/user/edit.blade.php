                            ...
                            <form method="post" action="{{url('admin/updateuser/')}}/{{$user->id}}" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            ...
                                            <input class="form-control" id="name" value="{{$user->name}}" name="name" type="text" placeholder="Enter User Name" />
                                        </div>
                                        <div class="col-md-6 form-group mb-3">
                                            <label for="position">Position</label>
                                            <input class="form-control" id="position" value="{{$user->position}}" name="position" type="Year" placeholder="Enter User Position" />
                                            ...
                                            <label for="role"> Select User Role</label>
                                             <select name="role" id="role" class="form-control" required>
                                              <option value="">none</option>
                                                ...
                                                <option value="4">Feevoucher Officer</option>
